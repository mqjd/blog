...
import { Context, useDeck } from '@mdx-deck/gatsby-plugin/src/context'
...
import Clock from '@mdx-deck/gatsby-plugin/src/clock'
import Timer from '@mdx-deck/gatsby-plugin/src/timer'
